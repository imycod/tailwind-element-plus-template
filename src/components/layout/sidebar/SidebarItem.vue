...
function resolvePath(routePath) {
  ...
  if (httpReg.test(routePath) || httpReg.test(props.basePath)) {
    ...
    // const basePath = new URL(props.basePath, window.location.origin);
    // const resolvedPath = new URL(routePath, basePath);
    // console.log("resolvedPath.href---", resolvedPath.href);
    console.log(
        "path.posix.resolve(props.basePath, routePath)",
        path.posix.resolve(props.basePath, routePath)
    );
